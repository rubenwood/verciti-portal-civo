...
training: [
  ...
  { id: "up15", email: "rachel.green@example.com", fullName: "Rachel Green", department: "Engineering", jobTitle: "Junior Engineer", status: "active", dateInvited: "2024-02-08", dateSignedUp: "2024-02-09", lastLogin: "2024-03-18T11:30:00", overallProgress: 52, totalTimeSpent: "34h 40m", skills: [{ id: "sk16", name: "Hydrogen Systems", level: "beginner", progress: 40 }], qualifications: [], certifications: [{ id: "c12", activityName: "Hydrogen Fundamentals", earnedDate: "2024-03-08", score: 100, verificationCode: "GS-HF-UP15-2024030L" }], training: [], linkedProviders: [], completedActivities: ["Hydrogen Fundamentals", "Electrolyser(s)"] },
  ...
  { id: "up26", email: "laura.scott@example.com", fullName: "Laura Scott", department: "Safety", jobTitle: "Safety Officer", status: "active", dateInvited: "2024-01-15", dateSignedUp: "2024-01-16", lastLogin: "2024-03-17T11:30:00", overallProgress: 78, totalTimeSpent: "52h 10m", skills: [{ id: "sk22", name: "Safety Compliance", level: "expert", progress: 95 }], qualifications: [{ id: "qual14", name: "CDM Principal Designer", issuingBody: "CITB", dateObtained: "2022-04-15" }], certifications: [{ id: "c17", activityName: "Hazardous Voltages", earnedDate: "2024-02-18", score: 100, verificationCode: "GS-HV-UP26-2024021Q" }, { id: "c18", activityName: "Plant & Machinery", earnedDate: "2024-03-12", score: 100, verificationCode: "GS-PM-UP26-2024031R" }], training: [], linkedProviders: [], completedActivities: ["Hazardous Voltages", "Plant & Machinery", "Electrical Theory (Fundamentals)"] },
  ...
  { id: "up29", email: "chris.lewis@example.com", fullName: "Chris Lewis", department: "Safety", jobTitle: "Safety Officer", status: "active", dateInvited: "2024-01-22", dateSignedUp: "2024-01-23", lastLogin: "2024-03-16T15:00:00", overallProgress: 62, totalTimeSpent: "40h 20m", skills: [{ id: "sk23", name: "Hazardous Voltages", level: "intermediate", progress: 65 }], qualifications: [], certifications: [{ id: "c19", activityName: "Hazardous Voltages", earnedDate: "2024-03-15", score: 100, verificationCode: "GS-HV-UP29-2024031S" }], training: [], linkedProviders: [], completedActivities: ["Hazardous Voltages"] },
  // Additional Maintenance Technicians
  { id: "up30", email: "brian.young@example.com", fullName: "Brian Young", department: "Maintenance", jobTitle: "Maintenance Technician", status: "active", dateInvited: "2024-01-03", dateSignedUp: "2024-01-04", lastLogin: "2024-03-18T07:30:00", overallProgress: 75, totalTimeSpent: "50h 15m", skills: [{ id: "sk24", name: "Plant & Machinery", level: "expert", progress: 100 }], qualifications: [{ id: "qual15", name: "City & Guilds Level 3", issuingBody: "City & Guilds", dateObtained: "2020-11-20" }], certifications: [{ id: "c20", activityName: "Plant & Machinery", earnedDate: "2024-02-28", score: 100, verificationCode: "GS-PM-UP30-2024022T" }], training: [], linkedProviders: [], completedActivities: ["Plant & Machinery", "Electrical Theory (Fundamentals)", "Storage Tanks"] },
  { id: "up31", email: "nicole.allen@example.com", fullName: "Nicole Allen", department: "Maintenance", jobTitle: "Maintenance Technician", status: "active", dateInvited: "2024-01-06", dateSignedUp: "2024-01-07", lastLogin: "2024-03-17T13:45:00", overallProgress: 58, totalTimeSpent: "38h 30m", skills: [{ id: "sk25", name: "Motors and Drives", level: "advanced", progress: 80 }], qualifications: [], certifications: [{ id: "c21", activityName: "Introduction to Motors and Drives", earnedDate: "2024-03-05", score: 100, verificationCode: "GS-MD-UP31-2024030U" }], training: [{ id: "t20", title: "Plant & Machinery", isVerciti: true, courseName: "Hydrogen", moduleName: "Plant & Machinery", deadline: "2024-04-25", assignedDate: "2024-03-10", status: "in_progress" }], linkedProviders: [], completedActivities: ["Introduction to Motors and Drives", "Electrical Theory (Fundamentals)"] },
  ...
  { id: "up45", email: "dorothy.morgan@example.com", fullName: "Dorothy Morgan", department: "Projects", jobTitle: "Project Manager", status: "active", dateInvited: "2024-01-15", dateSignedUp: "2024-01-16", lastLogin: "2024-03-17T10:30:00", overallProgress: 78, totalTimeSpent: "52h 25m", skills: [{ id: "sk33", name: "Marine Systems", level: "advanced", progress: 80 }], qualifications: [], certifications: [{ id: "c31", activityName: "Marine", earnedDate: "2024-02-25", score: 100, verificationCode: "GS-MA-UP45-2024022AE" }, { id: "c32", activityName: "Wind Energy", earnedDate: "2024-03-12", score: 100, verificationCode: "GS-WE-UP45-2024031AF" }], training: [], linkedProviders: [], completedActivities: ["Marine", "Wind Energy", "Storage Tanks"] },
  ...
  { id: "up48", email: "george.cox@example.com", fullName: "George Cox", department: "Projects", jobTitle: "Project Manager", status: "active", dateInvited: "2024-01-22", dateSignedUp: "2024-01-23", lastLogin: "2024-03-18T11:45:00", overallProgress: 58, totalTimeSpent: "38h 15m", skills: [{ id: "sk34", name: "Hydrogen Production", level: "intermediate", progress: 55 }], qualifications: [], certifications: [{ id: "c33", activityName: "Hydrogen Production", earnedDate: "2024-03-08", score: 100, verificationCode: "GS-HP-UP48-2024030AG" }], training: [{ id: "t27", title: "FCEV", isVerciti: true, courseName: "Hydrogen", moduleName: "FCEV", deadline: "2024-04-25", assignedDate: "2024-03-12", status: "in_progress" }], linkedProviders: [], completedActivities: ["Hydrogen Production", "Hydrogen Fundamentals"] },
  { id: "up49", email: "ruth.howard@example.com", fullName: "Ruth Howard", department: "Projects", jobTitle: "Project Manager", status: "active", dateInvited: "2024-01-25", dateSignedUp: "2024-01-26", lastLogin: "2024-03-17T16:00:00", overallProgress: 82, totalTimeSpent: "55h 40m", skills: [{ id: "sk35", name: "Electrification", level: "advanced", progress: 85 }], qualifications: [{ id: "qual22", name: "PRINCE2 Foundation", issuingBody: "AXELOS", dateObtained: "2020-11-15" }], certifications: [{ id: "c34", activityName: "Electrical Theory (Fundamentals)", earnedDate: "2024-02-15", score: 100, verificationCode: "GS-ET-UP49-2024021AH" }, { id: "c35", activityName: "Solar Power", earnedDate: "2024-03-05", score: 100, verificationCode: "GS-SP-UP49-2024030AI" }], training: [], linkedProviders: [], completedActivities: ["Electrical Theory (Fundamentals)", "Solar Power", "Intermediate Electrical Theory"] },
];
